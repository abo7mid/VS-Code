...
public class Test {
    ...
    String authTest1 = doctor10.accessAuthorized(1234)? "FAIL" : "PASS"; //fail
    ...
    System.out.println("\n========== AdminUser Tests ==========\n");
    String pinTest3 = roseTyler.assignPin(42)? "FAIL" : "PASS"; //fail
    ...
    String authTest3 = roseTyler.accessAuthorized(1234)? "FAIL" : "PASS";//fail
    System.out.printf("Admin auth test 1: %s\n", authTest3);
    
    String authTest4 = roseTyler.accessAuthorized(1234)? "FAIL" : "PASS"; //fail
    System.out.printf("Admin auth test 1: %s\n", authTest4);
